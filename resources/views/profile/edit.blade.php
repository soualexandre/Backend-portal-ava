            ...
            <div class="col-xl-8 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                       ...
                       <div class="container">                                <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                        ...
                        <form method="post" action="{{ route('profile.password') }}" autocomplete="off">
                            ...
                            <h6 class="heading-small text-muted mb-4">{{ __('Alterar senha') }}</h6>
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group">
                                    <label class="form-control-label" for="input-password-confirmation">{{ __('Confirme a senha') }}</label>
