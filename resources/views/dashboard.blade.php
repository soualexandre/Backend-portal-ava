...
@section('content')
    @include('users.partials.header', [
        ...
        'description' => __('Pensamos em você por isso oferecemos essa plataforma para uma melhor interação nos estudos'),
        'class' => 'col-lg-7'
    ])   
                ...
                <div class="card bg-gradient-default shadow">
                    <div class="card-header bg-transparent">
                        <div class="row align-items-center">
                            <div class="col">
                                <h6 class="text-uppercase text-light ls-1 mb-1">Atividades</h6>
                                <h2 class="text-white mb-0">Melhorando o seu rendimento</h2>
                            </div>
                            <div class="col">
                    ...
                    <div class="card-header bg-transparent">
                        <div class="row align-items-center">
                            <div class="col">
                                ...
                                <h2 class="mb-0">Total de atividades</h2>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
